...
/**
	 ...
	 * found in the LICENSE file at https://angular.io/license
	 */
class cj{constructor(e,t,n){this.filePath=e,this.name=t,this.members=n}assertNoMembers(){if(this.members.length)throw new Error(`Illegal state: symbol without members expected, but got ${JSON.stringify(this)}.`)}}var lj=cj;var pj=class{constructor(){this.cache=new Map}get(e,t,n){const r=`"${e}".${t}${(n=n||[]).length?`.${n.join(".")}`:""}`;let i=this.cache.get(r);return i||(i=new cj(e,t,n),this.cache.set(r,i)),i}},fj=Object.defineProperty({StaticSymbol:lj,StaticSymbolCache:pj},"__esModule",{value:!0});
/**
	 * @license
	 * Copyright Google Inc. All Rights Reserved.
	 *
